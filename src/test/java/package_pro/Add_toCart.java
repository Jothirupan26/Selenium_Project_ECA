...
public class Add_toCart extends Base_test {
	...
	public void AddCart() {
		...
		WebElement element4 = driver.findElement(By.xpath("//a[text()='Blue Top']"));
		Assert.assertTrue(element4.getText().equalsIgnoreCase("Blue Top"));

		WebElement element5 = driver.findElement(By.xpath("//a[text()='Winter Top']"));
		Assert.assertTrue(element5.getText().equalsIgnoreCase("Winter Top"));
